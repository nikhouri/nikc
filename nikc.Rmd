...
# Label data
labels <- merge(aggregate(Value ~ Country, data=df, FUN=first), df)
...
ggplot(df) +
    ...
    labs(title="Daily Average Oil Production - Middle East (Gulf Countries)",
         ...
         subtitle = "Crude oil, shale oil, oil sands, and NGLs (Source: BP Statistical Review of World Energy 2020)") +
    # Themeing & fonts
    theme_light() +
    theme(legend.position="hidden",
          text=element_text(size=15, family="Fira Sans Extra Condensed"),
...
# Data series
    ...
    labs(title="Bank of England Official Bank Rate 2000-2020",
         x="Date", y="Bank Rate in %", color=NULL,
         subtitle = 'Colour shows change in the rate\'s name: "Repo Rate" then "Official Bank Rate" (Source: Bank of England)') +
    # Themeing & fonts
    theme_light() +
...
ggplot() +
    ...
    labs(title="Firewall Blocks by Country for nikhouri.com, 2020-09-14 to 2020-09-20",
         subtitle="Processed ufw log extacts (MaxMind IP geolocation, IANA service/port registry)",
...
ggplot(df) +
    ...
    labs(x="CPU Utilization in %",y="CPU Temperature in °C", color=NULL, shape=NULL,
         ...
         subtitle="1-second samples of 5-minute runs of 2 activities, reading mail and web browsing (2020-10-08)") +
    # Themeing & fonts
    theme_light() + 
    theme(legend.position="top",
          text=element_text(size=15, family="Fira Sans Extra Condensed"),
